                ...
                <div className="row">
                    <div className="col-md-6">
                        <a href="https://www.envato.com" target="_blank" rel="noreferrer">
                            <span className="copy">&copy; Copyright {currentYear} - Abdullah Amer</span>
                        </a>
                    </div>
                    <div className="col-md-6">
                        <div className="social-icons">
                            ...
                            <a href="https://www.linkedin.com/in/abdullah-amer-962064217/" target="_blank" rel="noreferrer"><i className="fa fa-linkedin"></i></a>
